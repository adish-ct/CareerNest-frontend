                        ...
                        <div className="rounded-xl shadow bg-[#f7f7f7]">
                            <div className="flex flex-col shadow text-sm md:text-base lg:text-lg p-7 md:p-6 lg:p-11 gap-1 md:gap-2 lg:gap-3">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="w-3/4 text-start">
                                        Design, development, and deployment in
                                        web development process to build modern
                                        user interface components to enhance
                                        application. Developing, implementing
                                        highly responsive user interface
                                        components using React concepts and
                                        modifying as well.
                                    </div>
                                </div>
                                <div className="flex">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="w-3/4 text-start">
                                        We're making communications more
                                        flexible, intelligent, and personal, to
                                        help enterprises worldwide stay ahead.
                                        We provide unified communications.
                                    </div>
                                </div>
