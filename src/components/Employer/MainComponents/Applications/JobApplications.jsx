            ...
            <div className="w-full bg-[#f0efef] p-2 rounded-md">
                <div className="w-full rounded-md">
                    ...
                    <div className="flex flex-col pt-4 gap-2 w-full">
                        ...
                        <div class="flex flex-row justify-end items-center pt-2 pr-20 gap-4 cursor-pointer">
                            <div class="text-2xl text-gray-600 hover:text-gray-800">
                                <FaSort />
                            </div>
                            <div class="flex items-center bg-[#f7f7f7] rounded-lg shadow">
                                <input
                                    class="pl-3 py-2 bg-transparent bg-[#ffffff] rounded-l-lg focus:outline-none"
                                    type="text"
                                    placeholder="Search..."
                                />
                                <div class="p-2 text-[#000] hover:text-gray-800">
                                    <IoSearch />
                                </div>
                            </div>
                        </div>
